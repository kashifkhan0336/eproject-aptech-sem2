            ...
            <div class="container">
                <div class="tm-myaccount">
                    <ul class="nav tm-tabgroup" id="account" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="account-returns-tab" data-toggle="tab" href="#account-returns"
                               role="tab" aria-controls="account-returns" aria-selected="false">Returns</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="account-logout-tab" href="{{ route("customer-logout") }}" role="tab"
                    ...
                    <div class="tab-content" id="account-ontent">
                        <div class="tab-pane fade show active" id="account-dashboard" role="tabpanel"
                            ...
                            <div class="tm-myaccount-dashboard">
                                <p>Hello <b>{{ Auth::user()->firstName . " " . Auth::user()->lastName }}</b> (not <b>{{ Auth::user()->firstName . " " . Auth::user()->lastName }}</b>? <a

                        ...
                        <div class="col-lg-7 col-md-8 col-12">
                            <div class="tm-heroslider-contentwrapper">
                                <div class="tm-heroslider-content">
                                    ...
                                    <a href="{{ route("product.all") }}" class="tm-button">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row mt-30-reverse">
                    ...
                    <div class="col-lg-4 mt-30">
                        <div class="tm-feature">
                                <span class="tm-feature-icon">
                                    <img src="|{{ asset("assets/images/icons/icon-free-shipping.png") }}" alt="free shipping">
                                </span>
                    ...
                    <div class="col-lg-4 mt-30">
                        <div class="tm-feature">
                                <span class="tm-feature-icon">
                                    <img src="{{ asset("assets/images/icons/icon-fast-delivery.png") }}" alt="fast delivery">
                                </span>
                            <div class="tm-feature-content">
                                <h6>Fast Delivery</h6>
                    ...
                    <div class="col-lg-4 mt-30">
                        <div class="tm-feature">
                                <span class="tm-feature-icon">
                                    <img src="{{ asset("assets/images/icons/icon-247-support.png") }}" alt="24/7 Support">
                                </span>
                            <div class="tm-feature-content">
                                <h6>24/7 Support</h6>

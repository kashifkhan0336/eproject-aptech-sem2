...
<?php endif; ?>
        ...
        <?php if($headerWidgets = $this->getHeaderWidgets()): ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.widgets','data' => ['widgets' => $headerWidgets,'columns' => $this->getHeaderWidgetsColumns(),'data' => $widgetData]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <?php if($footerWidgets = $this->getFooterWidgets()): ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.widgets','data' => ['widgets' => $footerWidgets,'columns' => $this->getFooterWidgetsColumns(),'data' => $widgetData]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::widgets'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <?php if($subheading = $action->getModalSubheading()): ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.modal.subheading','data' => []] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH F:\Projects\eproject-aptech-sem2\vendor\filament\filament\src\/../resources/views/components/page.blade.php ENDPATH**/ ?>
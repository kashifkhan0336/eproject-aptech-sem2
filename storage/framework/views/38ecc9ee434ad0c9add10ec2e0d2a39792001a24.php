...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament-support::components.dropdown.header','data' => ['attributes' => \Filament\Support\prepare_inherited_attributes($attributes)->merge($slots),'darkMode' => config('filament.dark_mode')]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH F:\Projects\eproject-aptech-sem2\vendor\filament\filament\src\/../resources/views/components/dropdown/header.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('C4NhAZH')) {
    $componentId = $_instance->getRenderedChildComponentId('C4NhAZH');
    $componentTag = $_instance->getRenderedChildComponentTagName('C4NhAZH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C4NhAZH');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('C4NhAZH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH F:\Projects\eproject-aptech-sem2\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>
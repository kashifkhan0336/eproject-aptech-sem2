...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.page','data' => ['widgetData' => ['record' => $record],'class' => \Illuminate\Support\Arr::toCssClasses([
...
<?php $component->withAttributes(['widget-data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['record' => $record]),'class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses([
        ...
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.form.index','data' => ['wire:submit.prevent' => 'save']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['wire:submit.prevent' => 'save']); ?>
            ...
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.form.actions','data' => ['actions' => $this->getCachedFormActions(),'fullWidth' => $this->hasFullWidthFormActions()]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'filament::components.resources.relation-managers.index','data' => ['activeManager' => $activeRelationManager,'formTabLabel' => $this->getFormTabLabel(),'managers' => $relationManagers,'ownerRecord' => $record,'pageClass' => static::class]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH F:\Projects\eproject-aptech-sem2\vendor\filament\filament\src\/../resources/views/resources/pages/edit-record.blade.php ENDPATH**/ ?>
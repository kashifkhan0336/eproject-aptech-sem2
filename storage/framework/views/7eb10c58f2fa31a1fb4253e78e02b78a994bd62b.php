...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.link','data' => ['darkMode' => $darkMode,'tag' => $tag,'wire:click' => $wireClick,'href' => $href,'target' => $target,'disabled' => $disabled,'color' => $color,'tooltip' => $tooltip,'icon' => $icon,'size' => $size,'dusk' => $dusk,'class' => $class,'iconPosition' => $iconPosition]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH F:\Projects\eproject-aptech-sem2\storage\framework\views/2a93415eebe11ae0654f3bf341db32239f9642df.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('GuriXGq')) {
    $componentId = $_instance->getRenderedChildComponentId('GuriXGq');
    $componentTag = $_instance->getRenderedChildComponentTagName('GuriXGq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GuriXGq');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('GuriXGq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('4SLoUoP')) {
    $componentId = $_instance->getRenderedChildComponentId('4SLoUoP');
    $componentTag = $_instance->getRenderedChildComponentTagName('4SLoUoP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4SLoUoP');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('4SLoUoP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH F:\Projects\eproject-aptech-sem2\vendor\filament\filament\src\/../resources/views/components/layouts/app.blade.php ENDPATH**/ ?>
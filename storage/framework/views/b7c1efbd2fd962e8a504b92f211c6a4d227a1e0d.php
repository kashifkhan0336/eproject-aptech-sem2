                ...
                <div class="col-lg-4 col-12">
                    <div class="tm-header-options">
                            ...
                            <?php if(auth()->guard()->guest()): ?>
                                <a href="<?php echo e(route("customer.login-signup")); ?>">Login/Register1</a>
                            <?php endif; ?>
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(Auth::user()->role != "dealer"): ?>
                                        ...
                                        <ul>
                                            <li><a href="<?php echo e(route("customer-account")); ?>">My Account</a></li>
                                            <li><a href="<?php echo e(route("customer-cart")); ?>">Shopping Cart</a></li>
                                            <li><a href="<?php echo e(route("customer-logout")); ?>"><Logout></Logout></a></li>
                                        </ul>
                                        </div>
                                <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <li class="tm-header-nav-dropdown"><a href="#">Categories</a>
                        <ul>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(route("category.show", ["id"=>$category])); ?>"><?php echo e($category->name); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                        </ul>
                    </li>

                    <li><a href="<?php echo e(route("feedback.show")); ?>">Feedback</a></li>
                </ul>
            </nav>
        </div>
    </div>
...
<?php /**PATH F:\Projects\eproject-aptech-sem2\resources\views/partials/header.blade.php ENDPATH**/ ?>
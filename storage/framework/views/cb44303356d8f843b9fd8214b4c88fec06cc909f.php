...
<?php $component->withAttributes(['id' => $getId(),'label' => $getLabel(),'label-sr-only' => $isLabelHidden(),'helper-text' => $getHelperText(),'hint' => $getHint(),'hint-icon' => $getHintIcon(),'required' => $isRequired(),'state-path' => $getStatePath()]); ?>
    <div
        ...
        x-on:trix-file-accept="
            if (<?php echo e($hasToolbarButton('attachFiles') ? 'true' : 'false'); ?>) return

            $event.preventDefault()
        "
        <?php echo e($attributes->merge($getExtraAttributes())->class(['filament-forms-rich-editor-component space-y-2'])); ?>

        <?php echo e($getExtraAlpineAttributeBag()); ?>

    >
        <?php if (! ($isDisabled())): ?>
            <input id="trix-value-<?php echo e($getId()); ?>" type="hidden" />

            <trix-toolbar
                id="trix-toolbar-<?php echo e($getId()); ?>"
            ...
            >
                <div class="flex justify-between space-x-4 rtl:space-x-reverse overflow-x-auto items-stretch overflow-y-hidden">
                    <div class="flex items-stretch space-x-4 rtl:space-x-reverse focus:outline-none">
                        <?php if($hasToolbarButton(['bold', 'italic', 'strike', 'link'])): ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'bold','dataTrixKey' => 'b','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.bold')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'bold','data-trix-key' => 'b','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.bold')).'','tabindex' => '-1']); ?>
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('italic')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'italic','dataTrixKey' => 'i','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.italic')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'italic','data-trix-key' => 'i','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.italic')).'','tabindex' => '-1']); ?>
                                        <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('strike')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'strike','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.strike')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'strike','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.strike')).'','tabindex' => '-1']); ?>
                                        <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('link')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'href','dataTrixAction' => 'link','dataTrixKey' => 'k','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.link')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'href','data-trix-action' => 'link','data-trix-key' => 'k','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.link')).'','tabindex' => '-1']); ?>
                                        <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
                        ...
                        <?php if($hasToolbarButton(['h1', 'h2', 'h3'])): ?>
                            <div data-trix-button-group="heading-tools" class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                <?php if($hasToolbarButton('h1')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'heading1','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.h1')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'heading1','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.h1')).'','tabindex' => '-1']); ?>
                                        <?php echo e(__('forms::components.rich_editor.toolbar_buttons.h1')); ?>
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('h2')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'heading','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.h2')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'heading','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.h2')).'','tabindex' => '-1']); ?>
                                        <?php echo e(__('forms::components.rich_editor.toolbar_buttons.h2')); ?>
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('h3')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'subHeading','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.h3')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'subHeading','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.h3')).'','tabindex' => '-1']); ?>
                                        <?php echo e(__('forms::components.rich_editor.toolbar_buttons.h3')); ?>
                        ...
                        <?php if($hasToolbarButton(['blockquote', 'codeBlock', 'bulletList', 'orderedList'])): ?>
                            <div data-trix-button-group="block-tools" class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                <?php if($hasToolbarButton('blockquote')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'quote','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.blockquote')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'quote','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.blockquote')).'','tabindex' => '-1']); ?>
                                        <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('codeBlock')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'code','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.code_block')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'code','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.code_block')).'','tabindex' => '-1']); ?>
                                        <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('bulletList')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'bullet','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.bullet_list')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'bullet','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.bullet_list')).'','tabindex' => '-1']); ?>
                                        <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('orderedList')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAttribute' => 'number','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.ordered_list')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-attribute' => 'number','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.ordered_list')).'','tabindex' => '-1']); ?>
                                        <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                            'h-4',
                                            'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                        ...
                        <?php if($hasToolbarButton('attachFiles')): ?>
                            <div data-trix-button-group="file-tools" class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAction' => 'attachFiles','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.attach_files')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-action' => 'attachFiles','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.attach_files')).'','tabindex' => '-1']); ?>
                                    <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        'h-4',
                                        'dark:fill-current' => config('forms.dark_mode'),
                    ...
                    <?php if($hasToolbarButton(['undo', 'redo'])): ?>
                        ...
                        >
                            <?php if($hasToolbarButton('undo')): ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAction' => 'undo','dataTrixKey' => 'z','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.undo')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-action' => 'undo','data-trix-key' => 'z','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.undo')).'','tabindex' => '-1']); ?>
                                    <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        'h-4',
                                        'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                            ...
                            <?php if($hasToolbarButton('redo')): ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.rich-editor.toolbar-button','data' => ['dataTrixAction' => 'redo','dataTrixKey' => 'shift+z','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.redo')).'','tabindex' => '-1']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::rich-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-trix-action' => 'redo','data-trix-key' => 'shift+z','title' => ''.e(__('forms::components.rich_editor.toolbar_buttons.redo')).'','tabindex' => '-1']); ?>
                                    <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        'h-4',
                                        'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                ...
                <div data-trix-dialogs class="trix-dialogs" x-cloak>
                    ...
                    >
                        <div class="trix-dialog__link-fields">
                            <input
                                name="href"
                                placeholder="<?php echo e(__('forms::components.rich_editor.dialogs.link.placeholder')); ?>" aria-label="<?php echo e(__('forms::components.rich_editor.dialogs.link.label')); ?>" required data-trix-input
                                disabled
                                type="url"
                            ...
                            <div class="trix-button-group">
                                <input
                                    value="<?php echo e(__('forms::components.rich_editor.dialogs.link.buttons.link')); ?>"
                                ...
                                <input
                                    value="<?php echo e(__('forms::components.rich_editor.dialogs.link.buttons.unlink')); ?>"
            ...
            <trix-editor
                ...
                id="<?php echo e($getId()); ?>"
                input="trix-value-<?php echo e($getId()); ?>"
                placeholder="<?php echo e($getPlaceholder()); ?>"
                toolbar="trix-toolbar-<?php echo e($getId()); ?>"
                x-ref="trix"
            ...
            ></trix-editor>
        <?php else: ?>
            <div x-html="state" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
...
<?php endif; ?>
<?php /**PATH F:\Projects\eproject-aptech-sem2\vendor\filament\forms\src\/../resources/views/components/rich-editor.blade.php ENDPATH**/ ?>
<div
    x-data="{ error: undefined, state: <?php echo \Illuminate\Support\Js::from($getState())->toHtml() ?> }"
    x-init="
...
>
    <button
        ...
        x-ref="button"
        x-on:change="
            response = await $wire.setColumnValue(<?php echo \Illuminate\Support\Js::from($getName())->toHtml() ?>, <?php echo \Illuminate\Support\Js::from($recordKey)->toHtml() ?>, state)
...
<?php /**PATH F:\Projects\eproject-aptech-sem2\vendor\filament\tables\src\/../resources/views/columns/toggle-column.blade.php ENDPATH**/ ?>